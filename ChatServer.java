...
public class ChatServer extends JFrame {
    public ChatServer() {
        ...
        this.setLocationRealativeTo(null); // la metto al centro dello schermo
    ...
    public PannelloChatServer() {
        ...
        JLabel labNuovo = new JPanel("Nuovo Messaggio -> ", JLabel.CENTER);
    ...
    public void connetti() {
        // instanzio il Thread per le connesioni: numero massimo giocatori = 10
