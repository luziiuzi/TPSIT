...
public class ChatClient extends JFrame
{
  ...
  public ChatClient(String nomeClient)
  {
	super("Chat Client- " + nomeClient);
	...
	//dei messaggi
	PannelloChatClient pan = new PannelloChatClient(nomeClient);
...
class PannelloChatClient extends JPanel implements ActionListener
{
  ...
  public PannelloChatClient(String nomeClient)
  {
	super();
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
	gestioneServizio.spedisciMessaggioChat(nomeClient +":" + textNuovo.getText());
	textNuovo.setText("");
    }			
  }	
} 
