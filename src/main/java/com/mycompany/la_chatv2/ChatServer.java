...
{
  public ChatServer(String nomeClient) 
  {
    super("Chat Server- " + nomeClient);
	...
	PannelloChatServer pan = new PannelloChatServer(nomeClient);
	this.getContentPane().add(pan);
	this.setVisible(true);		
  }
}	
	
class PannelloChatServer extends JPanel implements ActionListener //action listener è l'interfaccia 
                                                                  //che ascolta attivamente tutti gli eventi 
                                                                  //es. click bottone
{
  private List lista;
  ...
  public PannelloChatServer(String nomeClient)
  {
 	super();
	...
	// scritte laterali   
	JLabel chat1 = new JLabel("  XChat  ",JLabel.CENTER);	
    chat1.setForeground(new Color(200,100,100));	  
	JLabel chat2 = new JLabel("  YChat  ",JLabel.CENTER);	
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
  	 gestioneServizio.spedisciMessaggio(nomeClient + ":" + textNuovo.getText());
	 textNuovo.setText("");
    }			
  }	
}	
